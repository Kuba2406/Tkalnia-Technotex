...
INSERT INTO zlecenia (
  numer, art_id, ilosc_m, ilosc_wykonana_m, ilosc_pozostala_m, status, data_utworzenia, termin_realizacji, priorytet, uwagi
) VALUES
  ('ZP-001/2025', 1, 5000, 1500, 3500, 'w_trakcie',   CURRENT_DATE - 14, CURRENT_DATE + 30,  'wysoki',   'Pilne'),
  ...
  ('ZP-004/2025', 4, 8000, 4200, 3800, 'w_trakcie',   CURRENT_DATE - 21, CURRENT_DATE + 14,  'krytyczny','Termin przesunięty'),
