...
export default function ZleceniaView() {
  ...
  const pozostaloM = Math.max(
    (Number.isFinite(form.ilosc_m) ? form.ilosc_m : 0) - (Number.isFinite(form.wykonane_m) ? form.wykonane_m : 0),
    0,
  );
    ...
    <div>
      ...
      >
        ...
        <div className="grid-2">
          <div className="form-group">
            <label>Ilość (m)</label>
            <input className="form-control" type="number" value={form.ilosc_m} onChange={e => setField('ilosc_m', parseFloat(e.target.value || '0'))} />
          </div>
          <div className="form-group">
            <label>Wykonane (m)</label>
            <input className="form-control" type="number" value={form.wykonane_m} onChange={e => setField('wykonane_m', parseFloat(e.target.value || '0'))} />
          </div>
        </div>
        <div className="grid-2">
          <div className="form-group">
          ...
          <div className="form-group">
            ...
            <input className="form-control" value={pozostaloM} readOnly />
          </div>
        </div>
        <div className="grid-2">
          <div className="form-group">
